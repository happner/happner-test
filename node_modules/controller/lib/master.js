...
ControllerMaster.prototype.start = function($happn, www, callback) {
...
ControllerMaster.prototype.runScript = function($happn, name, opts, callback) {
  try {
...
ControllerMaster.prototype.registerMarshal = function($happn, registration, callback) {
...
ControllerMaster.prototype.spawnMinions = function($happn, count, opts, callback) {
...
ControllerMaster.prototype.killMinions = function($happn, opts, callback) {
  opts = opts || {};
...
ControllerMaster.prototype.killMinion = function($happn, opts, callback) {
  opts = opts || {};
...
ControllerMaster.prototype.createMinion = function($happn, registration, callback) {
...
ControllerMaster.prototype.destroyMinion = function($happn, registration, callback) {
...
ControllerMaster.prototype.updateMinion = function($happn, update, callback) {
